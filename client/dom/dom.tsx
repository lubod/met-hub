    ...
    <div className='main'>
      <Container className='text-center text-light my-2 py-2 mx-auto border-secondary bg-very-dark rounded'>
        <Row className={oldData ? 'text-danger' : ''}>
          <Col xs={4}>
            <Text name='Place' value={dom.data.place} ></Text>
          </Col>
          <Col xs={4}>
            <Text name='Date' value={dom.data.date} ></Text>
          </Col>
          <Col xs={4}>
            <Text name='Time' value={dom.data.time} ></Text>
          </Col>
        </Row>
      </Container>
      <Container className='text-center text-light my-2 py-2 mx-auto border-secondary bg-very-dark rounded'>
        ...
        <Row>
          <Col xs={4}>
            <Data name='Temperature' value={oldData ? null : dom.data.temp} unit='°C' fix={1}></Data>
            <Trend data={dom.trendData.temp} range={2}></Trend>
          </Col>
          <Col xs={4}>
            <Data name='Humidity' value={oldData ? null : dom.data.humidity} unit='%' fix={0}></Data>
            <Trend data={dom.trendData.humidity} range={10}></Trend>
          </Col>
          <Col xs={4}>
            <Data name='Rain' value={oldData ? null : dom.data.rain} unit='' fix={0}></Data>
            <Trend data={dom.trendData.rain} range={1}></Trend>
          </Col>
        </Row>
      </Container>
      <Container className='text-center text-light my-2 py-2 mx-auto border-secondary bg-very-dark rounded'>
